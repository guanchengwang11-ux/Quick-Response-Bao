...
public sealed record DiagnosticSnapshot(
    ...
    string CapturedTargetWindow,
    string ConfirmationTargetWindow,
    bool? LastFocusRestored,
    int LastDeletedCharacterCount,
    bool? LastDeletionSucceeded,
    string LastReplacementMethod,
